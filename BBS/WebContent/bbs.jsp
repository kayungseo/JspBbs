<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.io.PrintWriter" %> <!-- library불러옴 = include -->
<%@ page import="bbs.BbsDAO" %> 
<%@ page import="bbs.Bbs" %> 
<%@ page import="java.util.ArrayList" %> <!-- 게시물 목록 출력을 위해 필요함 -->
<!DOCTYPE html>
<html>
<head>
				...
				<tbody>
					...
					%>	
						<tr>
							...
							<td><%=list.get(i).getBbsDate().substring(0,11) + list.get(i).getBbsDate().substring(11,13) + "시" +list.get(i).getBbsDate().substring(13,15) + "분" %></td>
